...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handlePessimisticLockException(PessimisticLockException e) {
        ...
        problemDetail.setType(URI.create("https://example.com/problems/resource-locked"));
    ...
    public ProblemDetail handleDocumentUploadException(DocumentUploadException e) {
        ...
        problemDetail.setType(URI.create("https://example.com/problems/upload-failed"));
    ...
    public ProblemDetail handleDocumentDeleteException(DocumentDeleteException e) {
        ...
        problemDetail.setType(URI.create("https://example.com/problems/delete-failed"));
    ...
    public ProblemDetail handleStorageException(StorageException e) {
        ...
        problemDetail.setType(URI.create("https://example.com/problems/storage-error"));
